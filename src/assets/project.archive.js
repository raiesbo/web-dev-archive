const projectsList = [
    ...
    },
    {
        ...
        "tags": ["React", "ECharts", "GitHub-Api", "Node", "Express"],
        "links": {
    ...
    {
        "title": "devPortfolio",
        "description": "Online space where to showcase featured projects in the software development, web application and websites context.",
        "tags": ["HTML", "CSS", "JS(ES6+)", "React"],
        "links": {
